...
unsigned long CDECL get_sizeof_x509_crt_struct(void);
...
unsigned long CDECL get_sizeof_pk_context_struct(void);
...
unsigned long CDECL get_sizeof_entropy_context_struct(void);
unsigned long CDECL get_sizeof_ctr_drbg_context_struct(void);
...
unsigned long CDECL get_sizeof_ssl_context_struct(void);
...
void CDECL search_tcp_layer(void);
void CDECL force_tcp_layer (int value);
short CDECL stick_init(void);
...
static const int16_t STIK_SEND_MAXSIZE = 1920;
