...
#endif /* defined(POLARSSL_ASN1_WRITE_C) */
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "POLARSSL_ERR_ASN1_BUF_TOO_SMALL" ) == 0 )
    {
        *value = ( POLARSSL_ERR_ASN1_BUF_TOO_SMALL );
        return( 0 );
    }
...
void test_suite_asn1_write_octet_string( char *hex_str, char *hex_asn1,
...
void test_suite_asn1_write_ia5_string( char *str, char *hex_asn1,
                            int buf_len, int result )
{
    int ret;
    unsigned char buf[150];
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "asn1_write_octet_string" ) == 0 )
    {
        ...
        test_suite_asn1_write_octet_string( param1, param2, param3, param4 );
        return ( 0 );

        return ( 3 );
    }
    else
    if( strcmp( params[0], "asn1_write_ia5_string" ) == 0 )
    {
        ...
        test_suite_asn1_write_ia5_string( param1, param2, param3, param4 );
        return ( 0 );
