...
#endif /* defined(POLARSSL_MEMORY_BUFFER_ALLOC_C) */
...
void test_suite_memory_buffer_alloc_self_test( )
{
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "memory_buffer_alloc_self_test" ) == 0 )
    {
    #ifdef POLARSSL_SELF_TEST
        ...
        test_suite_memory_buffer_alloc_self_test(  );
        return ( 0 );
    #endif /* POLARSSL_SELF_TEST */
