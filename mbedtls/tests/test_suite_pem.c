...
#ifdef POLARSSL_MD5_C
#ifdef POLARSSL_CIPHER_MODE_CBC
    if( strcmp( str, "POLARSSL_ERR_PEM_INVALID_ENC_IV" ) == 0 )
    {
        *value = ( POLARSSL_ERR_PEM_INVALID_ENC_IV );
        return( 0 );
    }
#endif // POLARSSL_PEM_PARSE_C
#endif // POLARSSL_AES_C
...
#ifdef POLARSSL_MD5_C
#ifdef POLARSSL_CIPHER_MODE_CBC
void test_suite_pem_read_buffer( char *header, char *footer, char *data, char *pwd,
                      int res )
{
    pem_context ctx;
    int ret;
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "pem_read_buffer" ) == 0 )
    {
    #ifdef POLARSSL_PEM_PARSE_C
    #ifdef POLARSSL_AES_C
    #ifdef POLARSSL_DES_C
        ...
        test_suite_pem_read_buffer( param1, param2, param3, param4, param5 );
        return ( 0 );
    #endif /* POLARSSL_PEM_PARSE_C */
    #endif /* POLARSSL_AES_C */
    #endif /* POLARSSL_DES_C */
