...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "POLARSSL_ECP_DP_NONE" ) == 0 )
    {
        *value = ( POLARSSL_ECP_DP_NONE );
        return( 0 );
    }
...
void test_suite_ecp_check_pub_priv( int id_pub, char *Qx_pub, char *Qy_pub,
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "ecp_check_pub_priv" ) == 0 )
    {
        ...
        test_suite_ecp_check_pub_priv( param1, param2, param3, param4, param5, param6, param7, param8 );
        return ( 0 );
