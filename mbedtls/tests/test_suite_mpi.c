...
void test_suite_mpi_add_mpi_inplace( int radix_X, char *input_X, int radix_A, char *input_A )
{
    mpi X, A;
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mpi_add_mpi_inplace" ) == 0 )
    {
        ...
        test_suite_mpi_add_mpi_inplace( param1, param2, param3, param4 );
        return ( 0 );
