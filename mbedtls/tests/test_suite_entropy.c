...
#endif /* defined(POLARSSL_ENTROPY_C) */
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "POLARSSL_ERR_ENTROPY_FILE_IO_ERROR" ) == 0 )
    {
        *value = ( POLARSSL_ERR_ENTROPY_FILE_IO_ERROR );
        return( 0 );
    }
#endif // POLARSSL_FS_IO
#endif // ENTROPY_HAVE_DEFAULT
#ifdef ENTROPY_HAVE_DEFAULT
    if( strcmp( str, "POLARSSL_ERR_ENTROPY_SOURCE_FAILED" ) == 0 )
    {
        *value = ( POLARSSL_ERR_ENTROPY_SOURCE_FAILED );
        return( 0 );
    }
#endif // ENTROPY_HAVE_DEFAULT
