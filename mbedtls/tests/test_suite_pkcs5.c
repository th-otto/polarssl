...
#endif /* defined(POLARSSL_PKCS5_C) */
...
void test_suite_pkcs5_pbes2( int params_tag, char *params_hex, char *pw_hex,
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "pkcs5_pbes2" ) == 0 )
    {
        ...
        test_suite_pkcs5_pbes2( param1, param2, param3, param4, param5, param6 );
        return ( 0 );
