...
const OPTIONS cms_options[] = {
    ...
    {"verify_retcode", OPT_VERIFY_RETCODE, '-', 0},
    {"verify_receipt", OPT_VERIFY_RECEIPT, '<', 0},
    {"cmsout", OPT_CMSOUT, '-', "Output CMS structure"},
    {"data_out", OPT_DATA_OUT, '-', 0},
    {"data_create", OPT_DATA_CREATE, '-', 0},
    {"digest_verify", OPT_DIGEST_VERIFY, '-', 0},
    {"digest_create", OPT_DIGEST_CREATE, '-', 0},
    {"compress", OPT_COMPRESS, '-', 0},
    {"uncompress", OPT_UNCOMPRESS, '-', 0},
    {"EncryptedData_decrypt", OPT_ED_DECRYPT, '-', 0},
    {"EncryptedData_encrypt", OPT_ED_ENCRYPT, '-', 0},
    {"debug_decrypt", OPT_DEBUG_DECRYPT, '-', 0},
    {"text", OPT_TEXT, '-', "Include or delete text MIME headers"},
    {"asciicrlf", OPT_ASCIICRLF, '-', 0},
    ...
    {"no_content_verify", OPT_NO_CONTENT_VERIFY, '-', 0},
    {"no_attr_verify", OPT_NO_ATTR_VERIFY, '-', 0},
    ...
    {"receipt_request_all", OPT_RR_ALL, '-', 0},
    {"receipt_request_first", OPT_RR_FIRST, '-', 0},
    ...
    {"secretkey", OPT_SECRETKEY, 's', 0},
    {"secretkeyid", OPT_SECRETKEYID, 's', 0},
    {"pwri_password", OPT_PWRI_PASSWORD, 's', 0},
    {"econtent_type", OPT_ECONTENT_TYPE, 's', 0},
    ...
    {"receipt_request_from", OPT_RR_FROM, 's', 0},
    {"receipt_request_to", OPT_RR_TO, 's', 0},
